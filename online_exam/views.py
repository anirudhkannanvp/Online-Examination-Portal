...
def faculty_add_question(request):
    return render(request ,'online_exam/faculty_add_question.html' , {"questions" : question_bank.objects.all()})
...
def faculty_modify_question(request):
    return render(request ,'online_exam/faculty_modify_question.html', {"questions" : question_bank.objects.all()})
...
def faculty_view_questions(request):
    return render(request ,'online_exam/faculty_view_questions.html', {"questions" : question_bank.objects.all()})
